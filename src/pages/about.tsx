      ...
      <div className="container">
        ...
        <article className="max-w-2xl min-w-0 text-base lg:text-lg text-fore-subtle">
          <mdx.p>
            ...
            and still stuck there. I love cloud and is <b>2x AWS Certified(<b>Cloud Practitioner(CCP) and Developer Associate (DVA-C01)</b>)</b>. I love Netflix, deep space and music(pop,mostly).
          </mdx.p>
