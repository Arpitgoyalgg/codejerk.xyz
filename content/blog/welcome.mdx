...
My first web development project is this: [To Do App](https://jeffjads-todo-app-react.netlify.app/). It's not much, but coding the app itself was fun! I wanted more. I wanted something serious. And what's a better project for a first timer like me than making my own website?
